...
GGML_API void quantize_row_iq2_nl_ref (const float * GGML_RESTRICT x, block_iq2_nl  * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_iq3_nl_ref (const float * GGML_RESTRICT x, block_iq3_nl  * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_iq2_nl (const block_iq2_nl  * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_iq3_nl (const block_iq3_nl  * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_iq2_nl (const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_iq3_nl (const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);

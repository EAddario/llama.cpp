...
constexpr float MAX_DOT_PRODUCT_ERROR_NL2 = 0.06f;
    ...
    for (int i = 0; i < GGML_TYPE_COUNT; i++) {
        ...
        if (qfns_cpu->from_float && qfns->to_float) {
            ...
            const float max_quantization_error =
                ...
                type == GGML_TYPE_IQ2_NL  ? MAX_QUANTIZATION_TOTAL_ERROR_2BITS :
                type == GGML_TYPE_IQ2_K   ? MAX_QUANTIZATION_TOTAL_ERROR_2BITS :
                type == GGML_TYPE_Q3_K    ? MAX_QUANTIZATION_TOTAL_ERROR_3BITS :
                type == GGML_TYPE_IQ3_S   ? MAX_QUANTIZATION_TOTAL_ERROR_3BITS :
                type == GGML_TYPE_IQ3_NL  ? MAX_QUANTIZATION_TOTAL_ERROR_3BITS :
            ...
            const float max_allowed_error = type == GGML_TYPE_IQ2_NL
                ? MAX_DOT_PRODUCT_ERROR_NL2
                : type == GGML_TYPE_Q2_K || type == GGML_TYPE_IQ2_XS || type == GGML_TYPE_IQ2_XXS ||
                  type == GGML_TYPE_IQ3_XXS || type == GGML_TYPE_IQ3_S || type == GGML_TYPE_IQ2_S ||
                  type == GGML_TYPE_IQ3_NL || type == GGML_TYPE_IQ2_K

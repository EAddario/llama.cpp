...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"--reduce-mem"},
        string_format("decrease memory usage by evicting weights from the OS cache after each layer (default: %s)", params.reduce_mem ? "true" : "false"),
        [](common_params & params) {
            params.reduce_mem = true;
        }
